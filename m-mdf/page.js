...
var labelGuardaRoupa = document.querySelector('label[for="placas-do-brasil"]');
var guardaRoupa = document.getElementById("placas-do-brasil");
...
placasdoBbrasil.addEventListener("change", function() {
    melhoresProdutos.innerHTML = ''; // Limpa o conteúdo existente
    melhoresProdutos.appendChild(createH2("placas-do-brasil Mdf"));
    //<h2>Produtos indicados:</h2>
    subcategoriaPos = 0;
    newText = [
...
['L 2 Guarda Roupa Casal 8 Portas e 4 Gavetas','L 3 Guarda Roupa Casal 7 Portas e 3 Gavetas','L 3 Guarda Roupa Casal 6 Portas e 2 Gavetas']];
    ...
    if(this.checked){
        ultimoLabel.style.fontWeight = 500;
        ultimoLabel = labelplacasdoBrasil;
        ultimoLabel.style.fontWeight = 900;
    }
  });
