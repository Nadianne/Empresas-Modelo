...
export var mourao = document.getElementById("mourao");
export var labelmourao= document.querySelector('label[for="mourao"]');

export var estaca = document.getElementById("estaca");
export var labelpestaca = document.querySelector('label[for="estaca"]');

export var varao = document.getElementById("varao");
export var labelvarao = document.querySelector('label[for="varao"]');

export var esteio = document.getElementById("esteio");
export var labelesteio = document.querySelector('label[for="esteio"]');
...
export var ultimoLabel = labelmourao;
