...
export var Sofa = document.querySelector('label[for="Sofa"]');
export var labelSofa = document.getElementById("Sofa");

export var Rack = document.getElementById("Rack");
export var labelRack = document.querySelector('label[for="Rack"]');
...
export var ultimoLabel = labelSofa;
