...
export var Assoalhado = document.getElementById("Assoalhado");
export var labelAssoalhado = document.querySelector('label[for="Assoalhado"]');

export var Lateral = document.getElementById("Lateral");
export var labelLateral = document.querySelector('label[for="Lateral"]');


export var ultimoLabel = labelAssoalhado;
