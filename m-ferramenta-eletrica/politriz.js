...
global.politriz.addEventListener("change", function () {
    global.produtosIndicados.innerHTML = '';
    global.setSubCategoriasTitulo(["Politriz"])
    global.setSubcategoriaIndex(0);
    global.setTamProdutosIndicados([1]);
    global.setImgAllPath(["../imagens-industria/politriz/"]);
    global.produtosIndicados.appendChild(global.createH2(global.subCategoriasTitulo[global.subcategoriaIndex]));

    global.setDefinicaoDoProduto([[
        'Politriz de 7" Black e Decker',
    ...
    global.setH1PopUpAll([
        [
            "Politriz <span>Black Decker </span>",
        ],
    ...
    global.setParagrafoPopUpAllText([
        [
            [
                "Com seu polidor Black+Decker você pode polir saliências ou bordas, bem como soltar rebites, ângulos redondos, cortar metais, etc. uma ferramenta fundamental para a conclusão de seus projetos.",
                "Estilo	127 V <br> Voltagem	110<br>Potência em watts <br> 1300 watts", "Voltagem: 127;", "Velocidade: 0-2800/ min (rpm);",
            ],
            [
